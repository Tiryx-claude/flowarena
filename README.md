...
16. ✅ Echte Reimschemata & Punchline-Wortschatz — Strophen nutzen zufällige Buchstaben-Schemata (AABBC, ABABC, AABCC, ABBAC u.a. statt reinem Monoreim), jeder Buchstabe eine eigene, garantiert andere Reim-Familie; von Hand geprüfte Battle-Rap-/Jugend-/Streamer-Wortschicht (assets/js/rhyme-slang.js, DE 29/EN 19/RU 11 Familien: Ego, Flex, Pleite, Skill, Knast, fake, snake, ban, clan, жир, понты, бан u.v.m.) ist der bevorzugte Standard-Pool in beiden Modi; Street-Modus verstärkt gezielt "scharfe" Battle-Energie, Normal-Modus "weiche" Status-/Humor-Energie — echte Verschiebung des Charakters, nicht nur der Menge; persistente Familien-Historie über Sessions/Spiele hinweg (nicht nur innerhalb einer Challenge) sorgt dafür, dass sich auch nach mehreren Runden noch frisch anfühlt (siehe docs/GAMEPLAY.md Abschnitt 7.1, Punkte 4c/6b/6c)
