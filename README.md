...
16. ✅ Echte Reimschemata & Punchline-Wortschatz — Strophen nutzen zufällige Buchstaben-Schemata (AABBC, ABABC, AABCC, ABBAC u.a. statt reinem Monoreim), jeder Buchstabe eine eigene, garantiert andere Reim-Familie; von Hand geprüfte Battle-Rap-/Jugend-/Streamer-Wortschicht (assets/js/rhyme-slang.js, DE 20/EN 15/RU 9 Familien: Ego, Flex, Pleite, fake, snake, жир, понты u.v.m.) ist jetzt der BEVORZUGTE STANDARD-Pool in beiden Modi (nicht nur Bonus) — Normal-Modus bereits "frech, modern, locker", Street-Modus zusätzlich hart auf Battle-/Diss-Vokabular gewichtet; bleibt auch über lange Sessions/Turniere hinweg punchy statt auf neutrales Vokabular zurückzufallen (siehe docs/GAMEPLAY.md Abschnitt 7.1, Punkte 4c/6b)
