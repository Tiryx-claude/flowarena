...
16. ✅ Echte Reimschemata & moderne Rap-Sprache — Strophen nutzen jetzt zufällige Buchstaben-Schemata (AABBC, ABABC, AABCC, ABBAC u.a. statt reinem Monoreim), jeder Buchstabe eine eigene, garantiert andere Reim-Familie; neue von Hand geprüfte moderne/Jugend-Slang-Wortschicht (assets/js/rhyme-slang.js) pro Sprache; Familien- und Wortauswahl gewichten jetzt Battle-/Street-Energie — Street-Modus fühlt sich dadurch spürbar anders an als der lockere Normal-Modus (siehe docs/GAMEPLAY.md Abschnitt 7.1, Punkte 4c/6b)
